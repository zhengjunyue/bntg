...
def load_chunk(
   ...
   # YZJ
    '''
    if data_lab.shape[0] != data_set.shape[0]:
        n=(data_lab.shape[0] - data_set.shape[0])
        if n % 2 ==0:
            n=int(n/2)
            print(n)
            data_lab = data_lab[left+n:-n]
        else:
            n=int(n/2)
            print("odd is", n)
            data_lab = data_lab[left+n:-n-1]
    '''
    print("max",max(data_lab))
    print("data_lab shape", data_lab.shape)
