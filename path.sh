export KALDI_ROOT=/data/ac1zy/kaldi
#export KALDI_ROOT=`pwd`/../../..
export PATH=/data/ac1zy/kaldi/egs/librispeech/s5/utils/:$KALDI_ROOT/tools/openfst/bin:/data/ac1zy/kaldi/egs/librispeech/s5:$PATH
...
LM_CORPUS_ROOT=/fastdata/ac1zy/kaldi/egs/libri/lm-corpus
